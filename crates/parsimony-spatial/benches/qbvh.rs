//! Criterion benchmarks for [`QbvhIndex`] against the [`BruteIndex`]
//! oracle, across four workloads:
//!
//! 1. `bulk_build` — build from `n` `(uid, aabb)` pairs.
...
use parsimony_spatial::{
    Aabb, BruteIndex, QbvhIndex, Sphere, SpatialIndex, SpatialIndexExt,
};
